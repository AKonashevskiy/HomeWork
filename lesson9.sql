...
+INSERT INTO `figures` VALUES (1,'Circle'),(2,'Rectangle'),(3,'Triangle');
...
+  CONSTRAINT `formulas_ibfk_1` FOREIGN KEY (`figure_id`) REFERENCES `figures` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
+) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
+/*!40101 SET character_set_client = @saved_cs_client */;
+
+--
...
+INSERT INTO `formulas` VALUES (1,1,'3.14*r**2'),(2,3,'0.5*b*h'),(3,2,'f*s');
...
+  PRIMARY KEY (`id`),
+  KEY `figure_id` (`figure_id`),
+  CONSTRAINT `squares_ibfk_1` FOREIGN KEY (`figure_id`) REFERENCES `figures` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
+
+-- Dump completed on 2016-09-14  6:08:43
